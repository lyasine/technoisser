                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Image.network(
                            editProfileScreenUsersRecord.photoUrl,
                            fit: BoxFit.fitWidth,
                          ),
                        ),
                      ),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller: displayNameTextFieldController ??=
                      ...
                      text: editProfileScreenUsersRecord.displayName,
                    ),
                    obscureText: false,
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller: emailAddressController ??=
                        TextEditingController(
                      text: editProfileScreenUsersRecord.phoneNumber,
                    ),
                    obscureText: false,
                    decoration: InputDecoration(
                      labelStyle:
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller: myBioController ??= TextEditingController(
                      text: editProfileScreenUsersRecord.bio,
                    ),
                    obscureText: false,
                    decoration: InputDecoration(
                      labelStyle:
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        final usersUpdateData = createUsersRecordData(
                          displayName:
                              displayNameTextFieldController?.text ?? '',
                          email: emailAddressController?.text ?? '',
                          photoUrl: uploadedFileUrl,
                          bio: myBioController?.text ?? '',
                        );
                        await editProfileScreenUsersRecord.reference
